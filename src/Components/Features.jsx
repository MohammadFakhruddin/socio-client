    ...
    <section className="max-w-7xl mx-auto px-6 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="bg-base-200 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
          <h3 className="text-xl font-semibold mb-3 text-secondary">Create & Manage Events</h3>
          <p>
        ...
        {/* Feature 3 */}
        <div className="bg-base-200 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
          <h3 className="text-xl font-semibold mb-3 text-secondary">Secure Authentication</h3>
          <p>
        ...
        {/* Feature 5 */}
        <div className="bg-base-200 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
          <h3 className="text-xl font-semibold mb-3 text-secondary">Responsive & User Friendly</h3>
          <p>
